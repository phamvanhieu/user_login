    ...
    <div class="row w-100">
        <div class="col-md-12">
            <form method="POST" class="border rounded bg-light shadow" enctype="multipart/form-data">
                <div class="title-login bg-warning text-center text-white pt-2 pb-2 rounded-top "><h1><?php echo $title ?></h1></div>
                <?php 
                ...
                <div class="row main">
                    ...
                    <div class="col-md-9">
                        <div class="form-group pl-3 pr-3">
                            ...
                            <input disabled value="<?php echo $user['username'] ?>" class="form-control">
                        </div>
                        <div class="form-group pl-3 pr-3">
                            <label><b>Full Name</b></label>
                            <input  value="<?php echo $user['fullname'] ?>" type="text" required name="fullname" class="form-control" placeholder="Nhập Fullname...">
                        </div>
                        <div class="form-group pl-3 pr-3">
                            <label><b>User Type</b></label>
                            <input disabled value="<?php echo $user['user_type'] ?>" class="form-control">
                        </div>
                        <div class="form-group pl-3 pr-3">
                            <label><b>Email</b></label>
                            <input  value="<?php echo $user['email'] ?>" type="text" required name="email" class="form-control" placeholder="Nhập Email...">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group pl-3 pr-3">
